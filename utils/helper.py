...
class collater:
    ...
    def __call__(self, data):
        ...
        ner_labels = [
            gen_ner_labels(ners, max_len, self.ner2idx) for ners in ner_labels
        ]
        rc_head_labels = [
            gen_rc_labels(rcs, max_len, self.rel2idx) for rcs in rc_head_labels
        ]
        rc_tail_labels = [
            gen_rc_labels(rcs, max_len, self.rel2idx) for rcs in rc_tail_labels
        ]
